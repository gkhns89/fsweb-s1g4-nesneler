...
describe("MenuElemaniOlustur örneği", () => {
  it("MenuElemaniOlustur nesne döndürüyor", () => {
    expect(functions.MenuElemaniOlustur("taco", 8, "lunch")).toEqual({
      isim: "taco",
      fiyat: 8,
      kategori: "lunch",
    });
...
describe("DegerlendirmeEkle", () => {
  it("DegerlendirmeEkle nesneleri içeren bir dizi döndürüyor", () => {
    expect(
      functions.DegerlendirmeEkle(degerlendirmeler, "Daniela", 5, "great eats!")
    ).toEqual(
      (degerlendirmeler = [
        {
          isim: "Nalan",
...
describe("AnahtardanDegerlendirmeAl", () => {
  it("AnahtardanDegerlendirmeAl bir string döndürüyor", () => {
    expect(functions.AnahtardanDegerlendirmeAl(degerlendirmeler, 0)).toBe(
      "Nalan isimli kişi 5 puan verdi ve şunları yazdı: Mükemmel atmosfer ve mükemmel vegan seçenekleri!"
    );
  });
  it("AnahtardanDegerlendirmeAl bir string döndürüyor", () => {
    expect(functions.AnahtardanDegerlendirmeAl(degerlendirmeler, 2)).toBe(
      "Kamuran isimli kişi 4 puan verdi ve şunları yazdı: eğlenceli bilgiler ve havalı hisler"
    );
  });
});
...
describe("SonDegerlendirmeyiAl", () => {
  it("SonDegerlendirmeyiAl bir string döndürüyor", () => {
    expect(functions.SonDegerlendirmeyiAl(degerlendirmeler)).toBe(
      `Reyna isimli kişi 3.5 puan verdi ve şunları yazdı: bu mekan bir harika dostum, yine de garsonun gülümsememesinden puan kırdım`
    );
  });
});
